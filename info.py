...
USERNAME = environ.get('USERNAME', "https://t.me/Heisenberhgg") # ADMIN USERNAME
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/gR8.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "electoral-allyn-moviehubl-d540d45c.koyeb.app/")
